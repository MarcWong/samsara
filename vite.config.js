...
// dev serves from the root instead. BASE_PATH lets the dev-branch test
// deploy (https://marcwong.github.io/samsara_test/) override this to its
// own repo name without touching the main production build.
