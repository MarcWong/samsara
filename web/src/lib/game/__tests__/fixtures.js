...
// default) that don't match what players actually get, so a green result
// there wouldn't have proven anything about the real game — this fixture
// exists specifically to test against the config real players see.
const REAL_CONFIG = {
