// Mirrors src/index.js's core.config(...) call verbatim. The old repo's own
// test/index.js used different numbers (20 points, [0,10] range, no SPR
// default) that don't match what players actually get. Both the real app
// (core.js) and the test suite (__tests__/fixtures.js) import this single
// copy so they can never silently drift apart the way test/index.js did.
const REAL_CONFIG = {
    defaultPropertyPoints: 13,
    talentSelectLimit: 3,
    propertyAllocateLimit: [0, 13],
    defaultPropertys: { SPR: 3 },
    talentConfig: {
        talentPullCount: 10,
